...
Tensor_Tests.file = Tensor_Tests/Tensor_Tests.pro
ModelGraph_Tests.file = ModelGraph_Tests/ModelGraph_Tests.pro
Training_Tests.file = Training_Tests/Training_Tests.pro
