...
VISIONAIFLOW_ANNOTATION_EXPORT foundation::Result<void> ValidateAnnotation(const Annotation &annotation);
VISIONAIFLOW_ANNOTATION_EXPORT foundation::Result<void> ValidateRasterMask(const RasterMask &mask, bool binaryOnly);

class VISIONAIFLOW_ANNOTATION_EXPORT AnnotationStore final
{
public:
