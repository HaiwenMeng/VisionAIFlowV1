...
foundation::Result<void> LocalServer::Start(const QString &serverName, const QLocalServer::SocketOptions socketOptions)
{
    ...
    m_server.setSocketOptions(socketOptions);
