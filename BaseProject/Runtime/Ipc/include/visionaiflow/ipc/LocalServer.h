...
{
class VISIONAIFLOW_IPC_EXPORT LocalServer final : public QObject
{
    Q_OBJECT

public:
    explicit LocalServer(QObject *parent = nullptr);
    foundation::Result<void> Start(const QString &serverName, QLocalServer::SocketOptions socketOptions = QLocalServer::UserAccessOption);
    void Stop();
