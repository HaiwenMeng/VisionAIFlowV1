...
cuda_compiler.commands = $$CUDA_NVCC --use-local-env -ccbin $$shell_quote($$CUDA_HOST_COMPILER) -c -std=c++17 -gencode arch=compute_75,code=sm_75 -Xcompiler /EHsc,/MD -I$$VAF_ROOT/BaseProject/Core/include -I$$CUDA_QMAKE_ROOT/include -o ${QMAKE_FILE_OUT} ${QMAKE_FILE_IN}
