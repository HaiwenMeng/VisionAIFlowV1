...
CUDA_HOST_COMPILER = F:/VS2022/BuildTools/VC/Tools/MSVC/14.36.32532/bin/Hostx64/x64
...
cuda_compiler.commands = cd /d $$VAF_CUDA_WORKING_DIRECTORY && $$CUDA_NVCC --use-local-env -ccbin $$CUDA_HOST_COMPILER -c -std=c++17 -gencode arch=compute_75,code=sm_75 -Xcompiler /EHsc,/MD -I$$VAF_ROOT/cpp/foundation/include -I$$VAF_ROOT/cpp/trainer_host/include -I$$CUDA_QMAKE_ROOT/include -o ${QMAKE_FILE_OUT} ${QMAKE_FILE_IN}
