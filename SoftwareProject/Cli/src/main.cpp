...
int main(int argc, char *argv[])
{
    ...
    const QJsonObject expectedPaths{
        {QStringLiteral("cmake"), QStringLiteral("F:/Qt6.7.3/Tools/CMake_64/bin/cmake.exe")},
        {QStringLiteral("qt"), QStringLiteral("F:/Qt6.7.3/6.7.3/msvc2019_64/bin/qmake.exe")},
        {QStringLiteral("msvc142_14_29"), QStringLiteral("D:/Program Files (x86)/Microsoft Visual Studio/2019/Community/VC/Tools/MSVC/14.29.30133")},
